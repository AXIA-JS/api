...
import substrateData from '@axia-js/types-support/metadata/v13/substrate-hex';
import substrateJson from '@axia-js/types-support/metadata/v13/substrate-json.json';
