...
const allExtensions = _objectSpread(_objectSpread(_objectSpread(_objectSpread({}, _substrate.substrate), _axia.axia), _shell.shell), _statemint.statemint); // the v4 signed extensions prior to the point of exposing these to the metadata.
