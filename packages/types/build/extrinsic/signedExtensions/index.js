...
export const allExtensions = _objectSpread(_objectSpread(_objectSpread(_objectSpread({}, substrate), axia), shell), statemint); // the v4 signed extensions prior to the point of exposing these to the metadata.
