const axiaApi = (function (exports, keyring, util, types, utilCrypto) {
  ...
  ***************************************************************************** */
  ...
  function calcLocked(api, bestNumber, locks) {
    ...
    if (Array.isArray(locks)) {
      ...
      vestingLocked = api.registry.createType('Balance', lockedBreakdown.filter(({
        ...
        amount
      }) => result.iadd(amount), new util.BN(0))); // get the maximum of the locks according to https://github.com/axia-tech/substrate/blob/master/srml/balances/src/lib.rs#L699
  ...
  function _getValues(api, childKey, keys) {
    // We actually would love to use multi-keys https://github.com/axia-tech/substrate/issues/9203
