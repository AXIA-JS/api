...
Upgrade priority: Medium. Contains fixes for parachain types, affecting historic block retrieval on AXIALunar.
...
- Update parachain types to support BetaNet v1
...
- Add types for the new `proposeParachain` module (as per BetaNet)
